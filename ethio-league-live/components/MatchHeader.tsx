...
export const MatchHeader = () => {
  return (
    <header className="rounded-2xl border border-border/40 overflow-hidden animate-fade-in">
      ...
      <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-4 px-4 sm:px-8 py-5">
        ...
        <div className="flex items-center gap-3 sm:gap-4 animate-slide-in-right">
          <Image
            src="/ethiopian-coffee-crest.png"
      ...
      <div className="px-4 sm:px-6 py-1.5 text-center border-t border-border/40">
