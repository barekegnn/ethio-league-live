...
export const Pitch = ({ team, stagger = 160, initialDelay = 300, animationKey }: PitchProps) => {
  ...
  return (
    <div className="relative w-full aspect-[3/4] sm:aspect-[4/5] lg:aspect-[3/4] rounded-2xl overflow-hidden pitch-bg border border-border/40">
      {/* Mowed stripes */}
      <div
      ...
      {/* Formation badge */}
      <div className="absolute top-3 left-3 z-10 px-2.5 py-1 rounded-md bg-black/60 border border-accent/40 backdrop-blur-sm">
      ...
      {positioned.map((p, i) => (
        ...
        >
          <div className="flex flex-col items-center gap-1.5">
            ...
            <span
              className="font-display text-xs sm:text-sm font-semibold text-white px-2 py-0.5 rounded text-shadow-broadcast whitespace-nowrap"
