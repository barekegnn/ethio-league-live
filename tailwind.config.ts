  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "slide-in-pitch": { "0%": { opacity: "0", transform: "translateY(20px) scale(0.85)" }, "100%": { opacity: "1", transform: "translateY(0) scale(1)" } },
        ...
        "scale-pop": { "0%": { opacity: "0", transform: "scale(0.5)" }, "60%": { transform: "scale(1.08)" }, "100%": { opacity: "1", transform: "scale(1)" } },
      ...
      animation: {
        ...
        "slide-in-pitch": "slide-in-pitch 0.6s cubic-bezier(0.16, 1, 0.3, 1) both",
