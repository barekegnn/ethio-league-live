...
const LeaguesPage = () => {
  useEffect(() => {
    document.title = "Leagues · Ethio-League Live";
  }, []);
    ...
    <div className="mx-auto max-w-4xl px-3 sm:px-6 py-4 sm:py-6 space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {leagues.map((l) => (
          ...
          >
            <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-primary to-primary-glow grid place-items-center text-primary-foreground">
